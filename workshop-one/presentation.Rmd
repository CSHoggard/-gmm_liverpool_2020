...
- **Workshop Two** (13th July): Landmark-based approaches to GMM (R practical)

--

- **Workshop Three** (27th July): Outline-based approaches to GMM (R practical)
...
- Slack Workspace for Q&A (beyond these three sessions) and informal discussion!
...
I will introduction the subject of geometric morphometrics (GMM), specifically:
...
“In general terms, the shape of an object, dataset or image that can be defined as the total of all information is invariant under **translation**, **rotation**, and **isotropic rescalings**” (Small, 1996: 6)
