...
```{r}
tutuli_lm <- rio::import("https://github.com/CSHoggard/-gmm_liverpool_2020/blob/master/workshop_two/tutuli_lm.rds")

tutuli_data <- rio::import("https://github.com/CSHoggard/-gmm_liverpool_2020/blob/master/workshop_two/tutuli_data.rds")   
